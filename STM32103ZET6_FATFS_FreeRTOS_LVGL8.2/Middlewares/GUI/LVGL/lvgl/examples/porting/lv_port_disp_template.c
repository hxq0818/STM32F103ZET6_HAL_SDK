...
//    lv_disp_draw_buf_init(&disp_buf_1, buf1_1, NULL, LV_HOR_RES_MAX * 10);   /*Initialize the display buffer*/
	  lv_disp_draw_buf_init(&disp_buf_1, color_buf, NULL, COLOR_BUF_SIZE);   /*Initialize the display buffer*/
		/*-----------------------------------
