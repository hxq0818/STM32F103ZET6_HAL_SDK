...
__align(32) u8 mem2base[MEM2_MAX_SIZE] __attribute__((at(0X68000000+320*480*2)));					//外部SRAM内存池

//内存管理表
u16 mem1mapbase[MEM1_ALLOC_TABLE_SIZE];													//内部SRAM内存池MAP
u16 mem2mapbase[MEM2_ALLOC_TABLE_SIZE] __attribute__((at(0X68000000+MEM2_MAX_SIZE+320*480*2)));	//外部SRAM内存池MAP
